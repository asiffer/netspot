...
#     w.write(svg)
bar.render_to_png(os.path.join(asset_folder, "perf-desktop.png"))
...
#     w.write(svg)
bar.render_to_png(os.path.join(asset_folder, "perf-rpi.png"))
...
box_plot.render_to_file(os.path.join(asset_folder, "perf-procs.svg"))
box_plot.render_to_png(os.path.join(asset_folder, "perf-procs.png"))
